...
export default function Projects() {
  ...
  const [projectArr] = useState([
    ...
    },
    {
      ...
      description:
        'I made this wordpress site for a company that gives language courses for companies or individuals.',
      tags: ['Wordpress', 'jQuerry', 'Twig'],
      github: '',
      website: 'https://cll.be',
      screen: 'cll',
      video: 'comingsoon',
      partial: false,
      id: 5,
    },
    {
      ...
      type: 'wordpress',
      description: '',
      tags: ['VueJs', 'wordpress API'],
      github: '',
      website: 'https://www.be-life.eu/',
      screen: 'belife',
      video: 'comingsoon',
      partial: false,
      id: 6,
    ...
    {
      title: 'John Cockerill',
      type: 'wordpress',
      description: '',
      tags: ['Wordpress', 'jQuery'],
      github: '',
      website: 'https://johncockerill.com/',
      screen: 'john',
      video: 'comingsoon',
      partial: false,
      id: 6,
    },
    {
      ...
      tags: ['Wordpress', 'jQuery'],
      github: '',
      website: 'https://www.eloywater.com/',
      screen: 'eloy',
      video: 'comingsoon',
      partial: false,
      id: 6,
